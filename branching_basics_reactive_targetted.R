...
# A branching process simulator that incorporates targeted vaccination of
# high risk groups (e.g. miners)
...
branching_process_model_reactive_target <- function(R_basic = 1.2,
  ...
  source("helper_functions_marburg_reactive_target.R")
...
# Example
# set.seed(1)
# x <- branching_process_model_reactive_target()
