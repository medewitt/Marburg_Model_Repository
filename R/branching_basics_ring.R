...
# A branching process simulator that incorporates ring vaccination of contacts
...
branching_process_model_ring <- function(R_basic = 1.2,
                                         ...
                                         mean_delay_vaccination_to_infection = 9,
                                         sd_delay_vaccination_to_infection = 4,
                                         max_delay = 30,
                                         break_point = 90) {
  source("make_disc_gamma.R")
  source("helper_functions_marburg_ring_vacc.R")
  ...
  for (t in 2:max_duration) {
    ...
    if (n_new_cases > 0) {
      ...
      # Draw features of the new cases. Since these may well be contact traced,
      # we will call our 2 helper functions
...
# # Example
# set.seed(1)
# x <- branching_process_model_ring()
